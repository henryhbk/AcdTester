...
/**
 * The Class EchoReport.
 *
 * @author Henry Feldman
 * @(C) IBM Watson Health 2021
 */
@Entity
@Table(name = "echo_reports")
@JsonRootName(value = "EchoReport")
public class EchoReport extends BaseEntity implements Serializable, HasText, HasFhir, HasImpression {
	 ...
	 */
	public EchoReport(Integer rowId, String category, int cgid, Date chartdate, String description, int hadmId,
			Boolean acdStudyNote, Integer subjectId, String text, String impression, String fhirJson) {
		super();
		this.rowId = rowId;
	...
	public String toString() {
		return "EKGReport [rowId=" + rowId + ", category=" + category + ", cgid=" + cgid + ", chartdate=" + chartdate
				...
				+ ", subjectId=" + subjectId + ", text=" + text + ", df=" + df + "]";
	}
