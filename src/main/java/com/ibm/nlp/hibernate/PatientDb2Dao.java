...
/**
 * The Class PatientDb2Dao is the DB2 variant for the PatientDao.
 *
 * @author Henry Feldman
 * @(C) IBM Watson Health 2021
 */
@SuppressWarnings("deprecation")
public class PatientDb2Dao extends HibernateDB2Dao implements PatientService {

	/**
	 * Instantiates a new patient dao.
	 */
	public PatientDb2Dao() {
		super();
